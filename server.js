...
app.get('/dashboard', ensureAuthenticated, function (req, res) {
  ...
  <li>For addition of two numbers enter the URL "http://localhost:4000/addTwoNumbers?n1=number1&n2=number2"</li>
  <li>For Multiplication of two numbers enter the URL "http://localhost:4000/multiplyTwoNumbers?n1=number1&n2=number2"</li>
  <li>For Division of two numbers enter the URL "http://localhost:4000/divideTwoNumbers?n1=number1&n2=number2"</li>
  <li>For Subtraction of two numbers enter the URL "http://localhost:4000/subtractTwoNumbers?n1=number1&n2=number2"</li>
  `);
});
